...
| Transform scheduling | Pinned payload layouts, AdvanceTransformProgram, fired dispatch block and update methods | 103841 birth/update steps, including simultaneous effects, shared turns, wait decrement and sound order | Bounce/wrap, sprites, child patterns and complete lifecycle |
